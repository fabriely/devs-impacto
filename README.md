...
#### Funcionalidades:
- ✅ **Tweet automático** quando novo PL é adicionado ao sistema
- ✅ **Alerta de lacuna** legislativa alta (≥ 70%) por tema
- ✅ **Resumo semanal** automático com estatísticas
- ✅ **Tweet de aprovação** quando PL é aprovado
- ✅ **API manual** para publicar tweets personalizados

#### Como Funciona:
1. **Auto-tweet em Novo PL**: Quando webhook recebe PL da Câmara, sistema automaticamente publica no Twitter
2. **Monitoramento de Lacunas**: Sistema detecta lacunas ≥ 70% e alerta seguidores
3. **Resumo Semanal**: Toda segunda-feira às 10h, publica estatísticas da semana
4. **Formato Otimizado**: Tweets com hashtags, emojis e URL do PL na Câmara
...
```
🏛️ Novo PL em tramitação!

PL 1234/2024
📋 Cria programa de saúde preventiva

Tema: Saúde 🏥
Status: Em tramitação

🔗 Acompanhe: camara.leg.br/...

#VozLocal #Cidadania #Saúde
```

#### Documentação Completa:
Ver [INTEGRACAO_TWITTER.md](./INTEGRACAO_TWITTER.md) para detalhes completos sobre configuração, autenticação OAuth 1.0a e troubleshooting.
...
Desenvolvido pela equipe **Devs Impacto** para o hackathon:

- **Fabriely Santos** - Full Stack Developer
- **Marcos Gabriel** - Full Stack Developer
- **João Teles** - Full Stack Developer
- **Gabriel Rocha** - Full Stack Developer
- **Matheus Pinheiro** - Full Stack Developer

### Contribuições:
- **Backend & APIs**: Integração WhatsApp, OpenAI, Câmara dos Deputados, Twitter
- **Frontend**: Dashboard interativo com Next.js e visualizações
- **DevOps**: Docker, CI/CD, configuração de ambiente
- **Banco de Dados**: Modelagem PostgreSQL, otimizações
